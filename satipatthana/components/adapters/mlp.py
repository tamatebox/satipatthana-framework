...
from satipatthana.configs.adapters import MlpAdapterConfig  # Changed import path
from satipatthana.configs.factory import create_adapter_config  # Added for dict support if needed
