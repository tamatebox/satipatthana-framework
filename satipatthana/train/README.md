...
This directory contains the training logic for Satipatthana Framework.

## Directory Structure

* **`trainer.py`**: `SatipatthanaTrainer` - 4-stage curriculum trainer extending Hugging Face's `Trainer`

## 4-Stage Curriculum Training

Satipatthana Framework uses a 4-stage curriculum learning approach:
...
```python
from satipatthana.train import Stage2NoiseStrategy
...
Training objectives are located in `satipatthana/components/objectives/`:
