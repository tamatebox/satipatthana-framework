"""
SamadhiSystem: Top-level system orchestrator for Samadhi Framework v4.0.

This module contains the SamadhiSystem class which integrates:
...
from samadhi.configs.system import SystemConfig
...
class SystemOutput(NamedTuple):
    """Output from SamadhiSystem forward pass."""
...
class SamadhiSystem(nn.Module):
    """
    Samadhi System - Top-level orchestrator for v4.0 architecture.
...
__all__ = ["SamadhiSystem", "TrainingStage", "SystemOutput"]
